...
<label className=' medname'  style={{fontSize:'16px',fontFamily:'revert-layer',marginLeft:'10px'}}>{product.categories}<i style={{float:'right',fontSize:'10px'}} class="fa-solid fa-eye mt-2"> : 150</i></label>
    ...
    <div style={{padding:'5px',marginTop:'-10px'}} class="card-body medbody">
        ...
        <div class="row ">
                ...
                <Image  class="cardimg" width='100%' src={product.images != null ? ('http://api.com/birimdik/uploads/'+ product.images) : ('http://api.com/birimdik/uploads/'+ 'no_image3.png')}/>
